    ...
    <>
        ...
        {relatedProducts.length > 0 && (
          <ul className="main-grid">
            {relatedProducts.slice(0, 3).map((related) => (
              <li key={related.handle}>
                <Link href={`/products/${related.handle}`} prefetch={true}>
                  ...
                  <h3>{related.title}</h3>
                  <Price
                    amount={related.priceRange.minVariantPrice.amount}
                    currencyCode={related.priceRange.minVariantPrice.currencyCode}
                  />
                </Link>
              </li>
            ))}
      ...
      <div style={{ width: "300px" }}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="185" height="28" viewBox="0 0 185 28" fill="none" style={{filter:'grayscale(100%)'}}>
          ...
          <path fillRule="evenodd" clipRule="evenodd" d="M68.2676 7.43555C69.9075 8.85103 70.9482 10.9559 70.9482 13.3076C70.9481 15.6589 69.907 17.7623 68.2676 19.1777C66.6285 17.7623 65.588 15.6585 65.5879 13.3076C65.5879 10.9563 66.6281 8.85102 68.2676 7.43555Z" fill="#FF5E00"/>
          <rect x="97.1271" y="0.279489" width="38.5695" height="26.272" rx="3.07438" fill="white" stroke="#D9D9D9" strokeWidth="0.558979"/>
          <path fillRule="evenodd" clipRule="evenodd" d="M108.727 18.1763H106.356L104.579 11.3949C104.494 11.083 104.315 10.8072 104.052 10.6772C103.394 10.3506 102.669 10.0906 101.879 9.95954V9.69845H105.697C106.225 9.69845 106.62 10.0906 106.686 10.5461L107.608 15.4378L109.977 9.69845H112.282L108.727 18.1763ZM113.599 18.1763H111.361L113.204 9.69845H115.443L113.599 18.1763ZM118.339 12.0471C118.405 11.5905 118.8 11.3294 119.261 11.3294C119.986 11.2638 120.775 11.3949 121.434 11.7204L121.829 9.89512C121.171 9.63404 120.446 9.50293 119.788 9.50293C117.616 9.50293 116.034 10.6772 116.034 12.307C116.034 13.5469 117.154 14.1979 117.945 14.5901C118.8 14.9812 119.13 15.2422 119.064 15.6333C119.064 16.2199 118.405 16.481 117.747 16.481C116.957 16.481 116.166 16.2855 115.443 15.9588L115.047 17.7853C115.838 18.1108 116.693 18.2419 117.484 18.2419C119.92 18.3063 121.434 17.1331 121.434 15.3722C121.434 13.1547 118.339 13.0247 118.339 12.0471ZM129.269 18.1763L127.491 9.69845H125.582C125.187 9.69845 124.792 9.95954 124.66 10.3506L121.368 18.1763H123.673L124.133 16.9376H126.964L127.228 18.1763H129.269ZM125.911 11.9815L126.569 15.1767H124.726L125.911 11.9815Z" fill="#172B85"/>
          <rect x="145.553" y="0.279489" width="38.5695" height="26.272" rx="3.07438" fill="white" stroke="#D9D9D9" strokeWidth="0.558979"/>

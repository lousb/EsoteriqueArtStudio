...
export type SETTINGS_QUERYResult = {
  ...
  footer: {
    ...
    exploreTitle: null;
    exploreLinks: null;
    customerServiceTitle: null;
    customerServiceLinks: null;
...
export type POLICY_PAGE_QUERYResult = null;
// Variable: HOME_QUERY
